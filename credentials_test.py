...
class TestUser(unittest.TestCase):
    def setUp(self):
        ...
        '''
        self.new_user = User("JoshKodhe", "passwd")
    ...
    def test_user_init(self):
        ...
        '''
        self.assertEqual(self.new_user.login_name, "JoshKodhe")
    ...
    def test_login(self):
        ...
        '''
        self.new_user.save_user()
        test_user = User("BinOluDara", "passworded")
        test_user.save_user()

        login_credentials = User.user_login("BinOluDara")
